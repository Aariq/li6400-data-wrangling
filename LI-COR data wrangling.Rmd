...
My first attempt at doing this was starting with excel files.  Unforutnately the .xls files from the Li-Cor can't be read by `read_xls()` so I had to open them in Excel and save them as .xlsx files as a starting point.
```{r}
